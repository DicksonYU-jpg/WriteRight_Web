...
export const Navbar = () => {
  ...
  return (
    <header className="absolute inset-x-0 top-0 z-50 py-9">
      <Container>
        <nav className="w-full flex justify-between gap-6 relative min-h-10">
          {/* Logo */}
          ...
          <div className="min-w-max flex items-center gap-x-3">
            ...
            <button
              onClick={toggleLang}
              className="outline-hidden flex relative text-heading-2 rounded-full w-2 lg:w-3 cursor-pointer"
            >
              {lang === "en" ? (
                <p>中</p>
              ) : (
